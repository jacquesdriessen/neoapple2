...
#
# neoapple2.tcl: Tcl script for re-creating project 'neoapple2'
#
# Generated by Vivado on Sat Jul 10 00:16:47 +0800 2021
...
#
# 1. This project restoration tcl script (neoapple2.tcl) that was generated.
#
...
#    "hdl/character_rom.vhd"
#    "hdl/video_generator.vhd"
#    "hdl/cpu6502.vhd"
#    "hdl/main_roms.vhd"
#    "hdl/apple2.vhd"
#    "hdl/keyboard.vhd"
...
proc checkRequiredFiles { origin_dir} {
  ...
  set paths [list \
   [file normalize "$origin_dir/../../vivado-library-master"] \
  ]
  foreach ipath $paths {
...
set orig_proj_dir "[file normalize "$origin_dir/neoapple2"]"
...
set obj [get_filesets sources_1]
set files [list \
 [file normalize "${origin_dir}/hdl/audio_pwm.v"] \
 [file normalize "${origin_dir}/hdl/disk_drive.v"] \
 [file normalize "${origin_dir}/hdl/ram.v"] \
 [file normalize "${origin_dir}/hdl/vga.v"] \
 [file normalize "${origin_dir}/hdl/PS2_Ctrl.vhd"] \
 [file normalize "${origin_dir}/hdl/timing_generator.vhd"] \
 [file normalize "${origin_dir}/hdl/character_rom.vhd"] \
 [file normalize "${origin_dir}/hdl/video_generator.vhd"] \
 [file normalize "${origin_dir}/hdl/cpu6502.vhd"] \
 [file normalize "${origin_dir}/hdl/main_roms.vhd"] \
 [file normalize "${origin_dir}/hdl/apple2.vhd"] \
...
set file "$origin_dir/hdl/PS2_Ctrl.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/hdl/timing_generator.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/hdl/character_rom.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/hdl/video_generator.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/hdl/cpu6502.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/hdl/main_roms.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/hdl/apple2.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/hdl/keyboard.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/hdl/disk_ii_rom.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/hdl/disk_ii.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
if { [get_files audio_pwm.v] == "" } {
  import_files -quiet -fileset sources_1 hdl/audio_pwm.v
}
if { [get_files disk_drive.v] == "" } {
  import_files -quiet -fileset sources_1 hdl/disk_drive.v
}
if { [get_files ram.v] == "" } {
  import_files -quiet -fileset sources_1 hdl/ram.v
}
if { [get_files vga.v] == "" } {
  import_files -quiet -fileset sources_1 hdl/vga.v
}
if { [get_files PS2_Ctrl.vhd] == "" } {
  import_files -quiet -fileset sources_1 hdl/PS2_Ctrl.vhd
}
if { [get_files timing_generator.vhd] == "" } {
  import_files -quiet -fileset sources_1 hdl/timing_generator.vhd
}
if { [get_files character_rom.vhd] == "" } {
  import_files -quiet -fileset sources_1 hdl/character_rom.vhd
}
if { [get_files video_generator.vhd] == "" } {
  import_files -quiet -fileset sources_1 hdl/video_generator.vhd
}
if { [get_files cpu6502.vhd] == "" } {
  import_files -quiet -fileset sources_1 hdl/cpu6502.vhd
}
if { [get_files main_roms.vhd] == "" } {
  import_files -quiet -fileset sources_1 hdl/main_roms.vhd
}
if { [get_files apple2.vhd] == "" } {
  import_files -quiet -fileset sources_1 hdl/apple2.vhd
}
if { [get_files keyboard.vhd] == "" } {
  import_files -quiet -fileset sources_1 hdl/keyboard.vhd
}
if { [get_files disk_ii_rom.vhd] == "" } {
  import_files -quiet -fileset sources_1 hdl/disk_ii_rom.vhd
}
...
# Z2_TOP
  ...
  # Create ports
  set KEY_0 [ create_bd_port -dir I -from 3 -to 0 KEY_0 ]
  set PS2_CLK_0 [ create_bd_port -dir I -type clk PS2_CLK_0 ]
  set PS2_DAT_0 [ create_bd_port -dir I PS2_DAT_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT1_JITTER {133.554} \
   CONFIG.CLKOUT1_PHASE_ERROR {94.860} \
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {64.45313} \
   CONFIG.CLKOUT2_JITTER {158.077} \
   CONFIG.CLKOUT2_PHASE_ERROR {94.860} \
   CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {28.64583} \
   CONFIG.CLKOUT2_USED {true} \
   CONFIG.CLKOUT3_JITTER {180.991} \
   CONFIG.CLKOUT3_PHASE_ERROR {94.860} \
   CONFIG.CLKOUT3_REQUESTED_OUT_FREQ {14.32292} \
   CONFIG.CLKOUT3_USED {true} \
   CONFIG.CLK_OUT1_PORT {CLK_64M} \
   CONFIG.CLK_OUT2_PORT {CLK_28M} \
   CONFIG.CLK_OUT3_PORT {CLK_14M} \
   CONFIG.MMCM_CLKFBOUT_MULT_F {8.250} \
   CONFIG.MMCM_CLKIN1_PERIOD {8.000} \
   CONFIG.MMCM_CLKOUT0_DIVIDE_F {16.000} \
   CONFIG.MMCM_CLKOUT1_DIVIDE {36} \
   CONFIG.MMCM_CLKOUT2_DIVIDE {72} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_FPGA0_PERIPHERAL_FREQMHZ {64.43181818181818} \
   CONFIG.PCW_FPGA1_PERIPHERAL_FREQMHZ {28.63636363636364} \
   CONFIG.PCW_FPGA2_PERIPHERAL_FREQMHZ {14.31818181818182} \
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/neoapple2/neoapple2.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
